    ...
    <footer className="site-footer">
      <div className="shell footer-grid">
        <div className="footer-intro">
          ...
          <p>{isKu ? "بۆ ژیانێک کە تێیدا هەر کەسێک بتوانێت گەشە بکات، هەڵبژێرێت و بەشدار بێت." : "For a life where every person can grow, choose and take part."}</p>
      ...
      <div className="shell footer-legal">
        ...
        <nav aria-label={isKu ? "سیاسەتەکان" : "Policies"}>
          ...
          <Link href={`/${locale}/policies/privacy`}>{isKu ? "تایبەتمەندی" : "Privacy"}</Link>
