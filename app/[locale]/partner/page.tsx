...
export default async function PartnerPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <>
    <PageHero eyebrow={isKu ? "هاوبەشی" : "Partnership"} title={isKu ? "بەیەکەوە دەرفەت زیاتر دەکەین." : <>Let’s make access<br /><em>better together.</em></>} intro={<p>{isKu ? "هیچ ڕێکخراوێک بە تەنها ناتوانێت کۆمەڵگایەکی گشتگیر دروست بکات. هاوبەشی، زانیاری و شارەزایی و سەرچاوەی دروست لە یەک شوێن کۆدەکاتەوە." : "No organization can build inclusion alone. Partnership brings the right knowledge, people and resources together."}</p>} aside={<p>{isKu ? "لە سەرەتاوە لەسەر ئامانج، ڕۆڵی هەردوو لا و پاراستنی کەسان ڕێکدەکەوین." : "We begin by agreeing on the goal, each side’s role and how people will be protected."}</p>} />
