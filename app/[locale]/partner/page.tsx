...
const description = { en: "Partnership pathways for funders, companies, experts and institutions working with Zane Foundation.", ku: "ڕێگاکانی هاوبەشی بۆ فەندەر، کۆمپانیا، پسپۆڕ و دامەزراوە بۆ کارکردن لەگەڵ فاوندەیشنی زەنێ." };
...
export default async function PartnerPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  return <>
    <PageHero eyebrow={isKu ? "هاوبەشی" : "Partnership"} title={isKu ? "بەیەکەوە کۆسپ کەم دەکەینەوە و دەرفەت فراوان دەکەین." : <>Remove barriers.<br /><em>Expand opportunity.</em></>} intro={<p>{isKu ? "هاوبەشیی بەهێز زانیاری، پسپۆڕی، سەرچاوە و دەنگی کۆمەڵگا بەیەکەوە دەبەستێتەوە." : "Strong partnerships connect knowledge, expertise, resources and community voice around shared action."}</p>} aside={<p>{isKu ? "هاوبەشییەکانمان لەسەر بەهای هاوبەش، ڕۆڵی ڕوون و ڕێز بۆ ماف و شکۆی مرۆڤ دادەمەزرێن." : "Our partnerships are grounded in shared values, clear roles and respect for human rights and dignity."}</p>} />
    ...
    <section className="partner-expect section-pad section-ink"><div className="shell partner-expect__grid"><div><SectionHeading inverse eyebrow={isKu ? "شێوازی هاوبەشی" : "How partnership works"} title={isKu ? "ئامانجی هاوبەش. ڕۆڵی ڕوون. پەیوەندیی بەردەوام." : "Shared purpose. Clear roles. Open communication."} /></div><ul>{[
