...
export default async function SafeguardingPage({ params }: { params: Promise<{ locale: string }> }) {
  ...
  const sections = isKu ? [
    ...
    { title: "پاراستن لە کرداردا", items: ["ڕێگای ڕوون بۆ ڕاپۆرتکردنی نیگەرانی", "بەرپرسیاریی دیاریکراو بۆ بەدواداچوون", "پشکنینی گونجاوی کارمەند و خۆبەخش بەپێی ڕۆڵ", "ڕاهێنان، ڕێنمای هەڵسوکەوت و ڕەوانەکردنی بەرپرسانە"] },
